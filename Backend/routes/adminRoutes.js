...
const {getAllBookings,approveBooking,rejectBooking, idCardView,allocateRoom,getAvailableRooms,vacateRoom, getCalendarBookings,finalizeBooking,extendStayInvoice}=require('../controllers/adminBookingcontroller');
